...
namespace Magicodes.Admin.Authorization.Users
{
    ...
    /// </summary>
    public class UserManager : NewAbpUserManager
    {
        ...
        {
            using (_unitOfWorkManager.Current.SetTenantId(userIdentifier.TenantId))//userIdentifier.TenantId
            {
                var u = userIdentifier.UserId.ToString();
