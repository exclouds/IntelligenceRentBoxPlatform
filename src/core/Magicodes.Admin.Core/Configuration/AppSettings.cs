namespace Magicodes.Admin.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        {
            public const string IsEnabled = "App.WeChatManagement.IsEnabled";
            public const string AppId = "App.WeChatManagement.AppId";
            public const string AppSecret = "App.WeChatManagement.AppSecret";
            public const string WeiXinAccount = "App.WeChatManagement.WeiXinAccount";
            public const string Token = "App.WeChatManagement.Token";
        }
