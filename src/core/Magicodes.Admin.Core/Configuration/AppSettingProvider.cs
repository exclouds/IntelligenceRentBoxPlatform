    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            ...
            return GetHostSettings().Union(GetTenantSettings()).Union(GetSharedSettings()).Union(GetPaySettings())
                .Union(GetSmsCodeSettings()).Union(GetStorageCodeSettings()).Union(GetMiniProgramSettings()).Union(GetWeChatSettings());
        }
        ...
        private IEnumerable<SettingDefinition> GetWeChatSettings() => new[] {
            new SettingDefinition(AppSettings.WeChatManagement.AppId, GetFromAppSettings(AppSettings.WeChatManagement.AppId,""),scopes:SettingScopes.Tenant|SettingScopes.Application),
            new SettingDefinition(AppSettings.WeChatManagement.AppSecret, GetFromAppSettings(AppSettings.WeChatManagement.AppSecret,""),scopes:SettingScopes.Tenant|SettingScopes.Application),
            new SettingDefinition(AppSettings.WeChatManagement.IsEnabled, GetFromAppSettings(AppSettings.WeChatManagement.IsEnabled, "false"), scopes:SettingScopes.Tenant| SettingScopes.Application),
            new SettingDefinition(AppSettings.WeChatManagement.WeiXinAccount, GetFromAppSettings(AppSettings.WeChatManagement.WeiXinAccount, ""), scopes:SettingScopes.Tenant| SettingScopes.Application),
            new SettingDefinition(AppSettings.WeChatManagement.Token, GetFromAppSettings(AppSettings.WeChatManagement.Token, ""), scopes:SettingScopes.Tenant| SettingScopes.Application),
        };
    }
}
