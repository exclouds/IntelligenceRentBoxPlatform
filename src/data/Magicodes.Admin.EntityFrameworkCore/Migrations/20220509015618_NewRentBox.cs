...
{
    public partial class NewRentBox : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessLicense = table.Column<string>(maxLength: 200, nullable: true),
                    CompanyType = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationCode = table.Column<string>(maxLength: 100, nullable: true),
                    ...
                    SignInToken = table.Column<string>(maxLength: 500, nullable: true),
                    TelNumber = table.Column<string>(maxLength: 20, nullable: true),
                    UserNature = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(nullable: true),
                    Remarks = table.Column<string>(maxLength: 500, nullable: true),
                    BaseKey_ValueTypeCode = table.Column<string>(maxLength: 20, nullable: true),
                    Code = table.Column<string>(maxLength: 20, nullable: false),
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    SystemSetting = table.Column<bool>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseKey_Value", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "BaseKey_ValueType",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseKey_ValueType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(nullable: true),
                    Remarks = table.Column<string>(maxLength: 500, nullable: true),
                    BoxTenantInfo = table.Column<int>(nullable: false),
                    Box = table.Column<string>(maxLength: 50, nullable: false),
                    Size = table.Column<string>(maxLength: 50, nullable: false),
                    Quantity = table.Column<int>(nullable: false),
                    BoxNO = table.Column<string>(maxLength: 50, nullable: true),
                    BoxAge = table.Column<double>(nullable: false),
                    ImageUrl = table.Column<string>(maxLength: 150, nullable: true),
                    CertificateUrl = table.Column<string>(maxLength: 150, nullable: true),
                    IsVerify = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoxDetailses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(nullable: true),
                    Remarks = table.Column<string>(maxLength: 500, nullable: true),
                    StartStation = table.Column<string>(maxLength: 50, nullable: false),
                    EndStation = table.Column<string>(maxLength: 50, nullable: false),
                    ReturnStation = table.Column<string>(maxLength: 50, nullable: false),
                    IsInStock = table.Column<bool>(nullable: false),
                    PredictTime = table.Column<DateTime>(nullable: true),
                    EffectiveSTime = table.Column<DateTime>(nullable: false),
                    EffectiveETime = table.Column<DateTime>(nullable: false),
                    SellingPrice = table.Column<decimal>(nullable: false),
                    Line = table.Column<string>(maxLength: 50, nullable: true),
                    IsEnable = table.Column<bool>(nullable: false),
                    IsVerify = table.Column<bool>(nullable: false),
                    VerifyRem = table.Column<string>(maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoxInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(nullable: true),
                    Remarks = table.Column<string>(maxLength: 500, nullable: true),
                    ConNo = table.Column<string>(maxLength: 50, nullable: false),
                    Type = table.Column<string>(maxLength: 5, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactNO", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remarks = table.Column<string>(maxLength: 500, nullable: true),
                    Code = table.Column<string>(maxLength: 50, nullable: false),
                    DepCode = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SiteTables", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EffectiveSTime = table.Column<DateTime>(nullable: false),
                    EffectiveETime = table.Column<DateTime>(nullable: false),
                    HopePrice = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
