...
namespace Magicodes.Admin.Migrations
{
    ...
    [Migration("20220519075247_update_BoxDetails")]
    partial class update_BoxDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Basis.ContactNO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Basis.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Basis.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Basis.LinSite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Basis.Line", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Basis.SiteTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("SiteTables");
                });

            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Business.BoxDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<double>("BoxAge");

                    b.Property<string>("BoxNO")
                        .HasMaxLength(50);

                    b.Property<string>("BoxTenantInfoNO")
                        .IsRequired()
                        .HasMaxLength(50);
                    ...
                    b.ToTable("BoxDetailses");
                });

            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Business.BoxInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime>("EffectiveETime");

                    b.Property<DateTime>("EffectiveSTime");
                    ...
                    b.Property<DateTime?>("PredictTime");
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Business.BusinessConfirm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("BoxInfoBillNO")
                        .HasMaxLength(50);
                    ...
                    b.Property<string>("TenantInfoBillNO")
                        .HasMaxLength(50);

                    b.Property<string>("TenantInfoId");

                    b.Property<decimal>("TenantMargin");

                    b.HasKey("Id");

                    b.ToTable("BusinessConfirms");
                });

            modelBuilder.Entity("Magicodes.Admin.Core.Custom.Business.TenantInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Magicodes.Admin.Core.Custom.DataDictionary.BaseKey_Value", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("BaseKey_ValueTypeCode")
                        .HasMaxLength(20);
                    ...
                    b.ToTable("BaseKey_Value");
                });

            modelBuilder.Entity("Magicodes.Admin.Core.Custom.DataDictionary.BaseKey_ValueType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Magicodes.Admin.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Magicodes.Admin.Organizations.MyOrganization", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("MyOrganization");
                });

            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Magicodes.Admin.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Magicodes.Admin.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Magicodes.Admin.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("Magicodes.Admin.Authorization.Users.User", "DeleterUser")
                        .WithMany()
